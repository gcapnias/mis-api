...
{
    /// <summary>
    /// Container for multiple Stations
    /// </summary>
    [DataContract]
        public partial class StationsRestDto :  IEquatable<StationsRestDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StationsRestDto" /> class.
        /// </summary>
        /// <param name="items">An array of Stations matching the query criteria.</param>
        ...
        public StationsRestDto(List<StationRestDto> items = default(List<StationRestDto>), List<Link> links = default(List<Link>), long? totalItems = default(long?))
        {
            // to ensure "totalItems" is required (not null)
            if (totalItems == null)
            {
                throw new InvalidDataException("totalItems is a required property for StationsRestDto and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// An array of Stations matching the query criteria
        /// </summary>
        /// <value>An array of Stations matching the query criteria</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<StationRestDto> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StationsRestDto {\n");
        ...
        {
            return this.Equals(input as StationsRestDto);
        }

        /// <summary>
        /// Returns true if StationsRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of StationsRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StationsRestDto input)
        {
            if (input == null)
                return false;
