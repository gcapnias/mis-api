...
{
    /// <summary>
    /// Container for multiple Camera statuses
    /// </summary>
    [DataContract]
        public partial class CamerasRestDto :  IEquatable<CamerasRestDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CamerasRestDto" /> class.
        /// </summary>
        /// <param name="items">An array of Cameras matching the query criteria.</param>
        ...
        public CamerasRestDto(List<CameraRestDto> items = default(List<CameraRestDto>), List<Link> links = default(List<Link>), long? totalItems = default(long?))
        {
            this.Items = items;
            this.Links = links;
        ...
        /// <summary>
        /// An array of Cameras matching the query criteria
        /// </summary>
        /// <value>An array of Cameras matching the query criteria</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<CameraRestDto> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CamerasRestDto {\n");
        ...
        {
            return this.Equals(input as CamerasRestDto);
        }

        /// <summary>
        /// Returns true if CamerasRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CamerasRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CamerasRestDto input)
        {
            if (input == null)
                return false;
