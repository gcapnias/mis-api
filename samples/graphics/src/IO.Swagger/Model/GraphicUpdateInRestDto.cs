...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GraphicUpdateInRestDto :  IEquatable<GraphicUpdateInRestDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GraphicUpdateInRestDto" /> class.
        /// </summary>
        ...
        public GraphicUpdateInRestDto(GraphicCircleRestDto circle = default(GraphicCircleRestDto), List<GeoLatLonRestDto> polygon = default(List<GeoLatLonRestDto>))
        {
            this.Circle = circle;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GraphicUpdateInRestDto {\n");
        ...
        {
            return this.Equals(input as GraphicUpdateInRestDto);
        }

        /// <summary>
        /// Returns true if GraphicUpdateInRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of GraphicUpdateInRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GraphicUpdateInRestDto input)
        {
            if (input == null)
                return false;
