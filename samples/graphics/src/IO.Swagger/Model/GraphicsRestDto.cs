...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GraphicsRestDto :  IEquatable<GraphicsRestDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GraphicsRestDto" /> class.
        /// </summary>
        /// <param name="items">An array of Graphics matching the query criteria.</param>
        ...
        public GraphicsRestDto(List<GraphicRestDto> items = default(List<GraphicRestDto>), List<Link> links = default(List<Link>), long? totalItems = default(long?))
        {
            this.Items = items;
            this.Links = links;
        ...
        /// <summary>
        /// An array of Graphics matching the query criteria
        /// </summary>
        /// <value>An array of Graphics matching the query criteria</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<GraphicRestDto> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GraphicsRestDto {\n");
        ...
        {
            return this.Equals(input as GraphicsRestDto);
        }

        /// <summary>
        /// Returns true if GraphicsRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of GraphicsRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GraphicsRestDto input)
        {
            if (input == null)
                return false;
