...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AlarmRestDto :  IEquatable<AlarmRestDto>, IValidatableObject
    {
        /// <summary>
        /// Type of Alarm
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmRestDto" /> class.
        /// </summary>
        ...
        public AlarmRestDto(int? alarmId = default(int?), List<Link> links = default(List<Link>), TrackIdsIdOnlyRestDto trackIds = default(TrackIdsIdOnlyRestDto), TypeEnum? type = default(TypeEnum?))
        {
        ...
        {
            return this.Equals(input as AlarmRestDto);
        }

        /// <summary>
        /// Returns true if AlarmRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmRestDto input)
        {
            if (input == null)
                return false;
