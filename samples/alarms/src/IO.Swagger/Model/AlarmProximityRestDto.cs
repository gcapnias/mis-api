...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AlarmProximityRestDto :  IEquatable<AlarmProximityRestDto>, IValidatableObject
    {
        /// <summary>
        /// Type of Alarm
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmProximityRestDto" /> class.
        /// </summary>
        ...
        public AlarmProximityRestDto(int? alarmId = default(int?), int? distance = default(int?), List<Link> links = default(List<Link>), TrackIdsIdOnlyRestDto trackIds = default(TrackIdsIdOnlyRestDto), TypeEnum? type = default(TypeEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlarmProximityRestDto {\n");
        ...
        {
            return this.Equals(input as AlarmProximityRestDto);
        }

        /// <summary>
        /// Returns true if AlarmProximityRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmProximityRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmProximityRestDto input)
        {
            if (input == null)
                return false;
