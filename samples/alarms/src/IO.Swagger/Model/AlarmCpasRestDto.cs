...
{
    /// <summary>
    /// Container for multiple Alarm Cpas
    /// </summary>
    [DataContract]
        public partial class AlarmCpasRestDto :  IEquatable<AlarmCpasRestDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmCpasRestDto" /> class.
        /// </summary>
        /// <param name="items">An array of Alarm CPAs matching the query criteria.</param>
        ...
        public AlarmCpasRestDto(List<AlarmCpaRestDto> items = default(List<AlarmCpaRestDto>), List<Link> links = default(List<Link>), long? totalItems = default(long?))
        {
            this.Items = items;
            this.Links = links;
        ...
        /// <summary>
        /// An array of Alarm CPAs matching the query criteria
        /// </summary>
        /// <value>An array of Alarm CPAs matching the query criteria</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<AlarmCpaRestDto> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlarmCpasRestDto {\n");
        ...
        {
            return this.Equals(input as AlarmCpasRestDto);
        }

        /// <summary>
        /// Returns true if AlarmCpasRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmCpasRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmCpasRestDto input)
        {
            if (input == null)
                return false;
