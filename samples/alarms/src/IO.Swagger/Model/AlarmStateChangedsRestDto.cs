...
{
    /// <summary>
    /// Container for multiple Alarm StateChangeds
    /// </summary>
    [DataContract]
        public partial class AlarmStateChangedsRestDto :  IEquatable<AlarmStateChangedsRestDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmStateChangedsRestDto" /> class.
        /// </summary>
        /// <param name="items">An array of Alarm StateChangeds matching the query criteria.</param>
        ...
        public AlarmStateChangedsRestDto(List<AlarmStateChangedRestDto> items = default(List<AlarmStateChangedRestDto>), List<Link> links = default(List<Link>), long? totalItems = default(long?))
        {
            this.Items = items;
            this.Links = links;
        ...
        /// <summary>
        /// An array of Alarm StateChangeds matching the query criteria
        /// </summary>
        /// <value>An array of Alarm StateChangeds matching the query criteria</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<AlarmStateChangedRestDto> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlarmStateChangedsRestDto {\n");
        ...
        {
            return this.Equals(input as AlarmStateChangedsRestDto);
        }

        /// <summary>
        /// Returns true if AlarmStateChangedsRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmStateChangedsRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmStateChangedsRestDto input)
        {
            if (input == null)
                return false;
