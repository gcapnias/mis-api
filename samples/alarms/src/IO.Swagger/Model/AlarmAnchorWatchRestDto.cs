...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AlarmAnchorWatchRestDto :  IEquatable<AlarmAnchorWatchRestDto>, IValidatableObject
    {
        /// <summary>
        /// Type of Alarm
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmAnchorWatchRestDto" /> class.
        /// </summary>
        /// <param name="alarmId">ID of the Alarm.</param>
        /// <param name="distance">[1 and greater]: Anchor Area expected to stay within (in meters).</param>
        ...
        public AlarmAnchorWatchRestDto(int? alarmId = default(int?), int? distance = default(int?), List<Link> links = default(List<Link>), TrackIdsIdOnlyRestDto trackIds = default(TrackIdsIdOnlyRestDto), TypeEnum? type = default(TypeEnum?))
        {
        ...
        /// <summary>
        /// [1 and greater]: Anchor Area expected to stay within (in meters)
        /// </summary>
        /// <value>[1 and greater]: Anchor Area expected to stay within (in meters)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlarmAnchorWatchRestDto {\n");
        ...
        {
            return this.Equals(input as AlarmAnchorWatchRestDto);
        }

        /// <summary>
        /// Returns true if AlarmAnchorWatchRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmAnchorWatchRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmAnchorWatchRestDto input)
        {
            if (input == null)
                return false;
