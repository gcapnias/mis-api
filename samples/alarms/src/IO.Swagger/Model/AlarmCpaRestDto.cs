...
{
    /// <summary>
    /// Not used - Alarm CPA/TCPA data
    /// </summary>
    [DataContract]
        public partial class AlarmCpaRestDto :  IEquatable<AlarmCpaRestDto>, IValidatableObject
    {
        /// <summary>
        /// Type of Alarm
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmCpaRestDto" /> class.
        /// </summary>
        ...
        public AlarmCpaRestDto(int? alarmId = default(int?), int? distance = default(int?), List<Link> links = default(List<Link>), int? time = default(int?), TrackIdsIdOnlyRestDto trackIds = default(TrackIdsIdOnlyRestDto), TypeEnum? type = default(TypeEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlarmCpaRestDto {\n");
        ...
        {
            return this.Equals(input as AlarmCpaRestDto);
        }

        /// <summary>
        /// Returns true if AlarmCpaRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmCpaRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmCpaRestDto input)
        {
            if (input == null)
                return false;
