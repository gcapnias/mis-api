...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AlarmStateChangedRestDto :  IEquatable<AlarmStateChangedRestDto>, IValidatableObject
    {
        /// <summary>
        /// Type of Alarm
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmStateChangedRestDto" /> class.
        /// </summary>
        ...
        public AlarmStateChangedRestDto(int? alarmId = default(int?), List<Link> links = default(List<Link>), TrackIdsIdOnlyRestDto trackIds = default(TrackIdsIdOnlyRestDto), TypeEnum? type = default(TypeEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlarmStateChangedRestDto {\n");
        ...
        {
            return this.Equals(input as AlarmStateChangedRestDto);
        }

        /// <summary>
        /// Returns true if AlarmStateChangedRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmStateChangedRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmStateChangedRestDto input)
        {
            if (input == null)
                return false;
