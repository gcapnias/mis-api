...
{
    /// <summary>
    /// Container for showing multiple Tracks IDs
    /// </summary>
    [DataContract]
        public partial class TrackIdsIdOnlyRestDto :  IEquatable<TrackIdsIdOnlyRestDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackIdsIdOnlyRestDto" /> class.
        /// </summary>
        /// <param name="items">An array of Track Ids.</param>
        ...
        public TrackIdsIdOnlyRestDto(List<TrackIdIdOnlyRestDto> items = default(List<TrackIdIdOnlyRestDto>), List<Link> links = default(List<Link>), long? totalItems = default(long?))
        {
            this.Items = items;
            this.Links = links;
        ...
        /// </summary>
        /// <value>An array of Track Ids</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<TrackIdIdOnlyRestDto> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackIdsIdOnlyRestDto {\n");
        ...
        {
            return this.Equals(input as TrackIdsIdOnlyRestDto);
        }

        /// <summary>
        /// Returns true if TrackIdsIdOnlyRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackIdsIdOnlyRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackIdsIdOnlyRestDto input)
        {
            if (input == null)
                return false;
