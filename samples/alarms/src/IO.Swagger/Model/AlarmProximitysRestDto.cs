...
{
    /// <summary>
    /// Container for multiple Alarm Proximitys
    /// </summary>
    [DataContract]
        public partial class AlarmProximitysRestDto :  IEquatable<AlarmProximitysRestDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmProximitysRestDto" /> class.
        /// </summary>
        /// <param name="items">An array of Alarm Proximitys matching the query criteria.</param>
        ...
        public AlarmProximitysRestDto(List<AlarmProximityRestDto> items = default(List<AlarmProximityRestDto>), List<Link> links = default(List<Link>), long? totalItems = default(long?))
        {
            this.Items = items;
            this.Links = links;
        ...
        /// <summary>
        /// An array of Alarm Proximitys matching the query criteria
        /// </summary>
        /// <value>An array of Alarm Proximitys matching the query criteria</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<AlarmProximityRestDto> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlarmProximitysRestDto {\n");
        ...
        {
            return this.Equals(input as AlarmProximitysRestDto);
        }

        /// <summary>
        /// Returns true if AlarmProximitysRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmProximitysRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmProximitysRestDto input)
        {
            if (input == null)
                return false;
