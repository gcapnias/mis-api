...
{
    /// <summary>
    /// Container for multiple Alarm
    /// </summary>
    [DataContract]
        public partial class AlarmsRestDto :  IEquatable<AlarmsRestDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmsRestDto" /> class.
        /// </summary>
        /// <param name="items">An array of Alarms matching the query criteria.</param>
        ...
        public AlarmsRestDto(List<AlarmRestDto> items = default(List<AlarmRestDto>), List<Link> links = default(List<Link>), long? totalItems = default(long?))
        {
            this.Items = items;
            this.Links = links;
        ...
        /// <summary>
        /// An array of Alarms matching the query criteria
        /// </summary>
        /// <value>An array of Alarms matching the query criteria</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<AlarmRestDto> Items { get; set; }
        ...
        {
            return this.Equals(input as AlarmsRestDto);
        }

        /// <summary>
        /// Returns true if AlarmsRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmsRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmsRestDto input)
        {
            if (input == null)
                return false;
