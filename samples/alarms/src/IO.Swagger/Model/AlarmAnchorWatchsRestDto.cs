...
{
    /// <summary>
    /// Container for multiple Alarm Anchor Watchs
    /// </summary>
    [DataContract]
        public partial class AlarmAnchorWatchsRestDto :  IEquatable<AlarmAnchorWatchsRestDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmAnchorWatchsRestDto" /> class.
        /// </summary>
        /// <param name="items">An array of Alarm Anchor Watchs matching the query criteria.</param>
        ...
        public AlarmAnchorWatchsRestDto(List<AlarmAnchorWatchRestDto> items = default(List<AlarmAnchorWatchRestDto>), List<Link> links = default(List<Link>), long? totalItems = default(long?))
        {
            this.Items = items;
            this.Links = links;
        ...
        /// <summary>
        /// An array of Alarm Anchor Watchs matching the query criteria
        /// </summary>
        /// <value>An array of Alarm Anchor Watchs matching the query criteria</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<AlarmAnchorWatchRestDto> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlarmAnchorWatchsRestDto {\n");
        ...
        {
            return this.Equals(input as AlarmAnchorWatchsRestDto);
        }

        /// <summary>
        /// Returns true if AlarmAnchorWatchsRestDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmAnchorWatchsRestDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmAnchorWatchsRestDto input)
        {
            if (input == null)
                return false;
